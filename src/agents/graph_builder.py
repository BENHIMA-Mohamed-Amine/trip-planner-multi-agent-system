...
def graph_builder() -> None:
    ...
    graph.add_node(ToolNode(tools=calendar_tools, name="calendar_tools", messages_key="chat_history"))
    graph.add_node(ToolNode(tools=flight_tools, name="flight_tools", messages_key="chat_history"))
